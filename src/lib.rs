...
#[derive(Debug)]
pub struct FastifyAPIProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FastifyAPIProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FastifyAPI processing");
    
    let mut processor = FastifyAPIProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FastifyAPIProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FastifyAPIProcessor::new(false);
